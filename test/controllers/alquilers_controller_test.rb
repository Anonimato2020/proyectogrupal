...
class AlquilersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create alquiler" do
    assert_difference('Alquiler.count') do
      post alquilers_url, params: { alquiler: { estacionamiento_id: @alquiler.estacionamiento_id, fecha: @alquiler.fecha, hora: @alquiler.hora, nhora: @alquiler.nhora, tpago: @alquiler.tpago, usuario_id: @alquiler.usuario_id } }
    end
  ...
  test "should update alquiler" do
    patch alquiler_url(@alquiler), params: { alquiler: { estacionamiento_id: @alquiler.estacionamiento_id, fecha: @alquiler.fecha, hora: @alquiler.hora, nhora: @alquiler.nhora, tpago: @alquiler.tpago, usuario_id: @alquiler.usuario_id } }

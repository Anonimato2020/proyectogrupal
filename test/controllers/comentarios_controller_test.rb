...
class ComentariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create comentario" do
    assert_difference('Comentario.count') do
      post comentarios_url, params: { comentario: { descripcion: @comentario.descripcion, estacionamiento_id: @comentario.estacionamiento_id, puntuacion: @comentario.puntuacion, usuario_id: @comentario.usuario_id } }
    end
  ...
  test "should update comentario" do
    patch comentario_url(@comentario), params: { comentario: { descripcion: @comentario.descripcion, estacionamiento_id: @comentario.estacionamiento_id, puntuacion: @comentario.puntuacion, usuario_id: @comentario.usuario_id } }

...
class UsuariosTest < ApplicationSystemTestCase
  ...
  test "creating a Usuario" do
    ...
    fill_in "Apellidomaterno", with: @usuario.apellidoMaterno
    fill_in "Apellidopaterno", with: @usuario.apellidoPaterno
    fill_in "Autenticacion", with: @usuario.autenticacion_id
    ...
    fill_in "Nrodocumento", with: @usuario.nroDocumento
